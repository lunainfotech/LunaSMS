...
public class TermSixSADTO {
	...
	private TermInfoDTO T6;

	public TermSixSADTO(TermInfoDTO t1, TermInfoDTO t2, TermInfoDTO t3, TermInfoDTO t4, TermInfoDTO t5,
			TermInfoDTO t6) {
		super();
		T1 = t1;
		T2 = t2;
	...
	public TermInfoDTO getT6() {
		return T6;
	}

	public void setT6(TermInfoDTO t6) {
		T6 = t6;
	}
