...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		http.authorizeRequests().antMatchers("/location/heartbeat").permitAll()
				.antMatchers("/location/school/record/**").permitAll().antMatchers("/location/school/records/**")
				.permitAll().antMatchers("/location/school/records/block_code/**").permitAll()
				.antMatchers("/location/school/records/dictrict_code/**").permitAll()
				.antMatchers("/location/mandal/records/**").permitAll().antMatchers("/location/district/records/**")
				.permitAll()

				.anyRequest().authenticated().and().formLogin().loginPage("/users/signin/*")
