...
public class Student {
	...
	private String studentCastCertNo;
	...
	public Student(Integer id, int studentCode, BigInteger schoolCode, String studentFirstName, String studentLastName,
			...
			String studentBloodGroup, String studentReligion, String studentCast, String studentCastCertNo,
		...
		this.studentCastCertNo = studentCastCertNo;
	...
	public String getStudentCastCertNo() {
		return studentCastCertNo;
	}

	public void setStudentCastCertNo(String studentCastCertNo) {
		this.studentCastCertNo = studentCastCertNo;
	}
